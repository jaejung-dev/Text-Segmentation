...
def get_args_parser():
    ...
    parser.add_argument('--crello_root', type=str, default="/home/ubuntu/for_jjseol/crello_Hi-SAM",
    ...
    parser.add_argument('--lica_test_gt_dir', type=str, default="/home/ubuntu/data/text_segmentation_dataset/val_gt",
